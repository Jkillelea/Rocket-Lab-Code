...
classdef CEAinput
   ...
   methods
       function runCEA(obj)
         ...
         inpgen_rocket_3(obj.ox1,     obj.ox2,     obj.ox1wt, ...
                         obj.ox2wt,   obj.ox1T,    obj.ox2T,  ...
                         obj.ox1chem, obj.ox2chem,            ...
                         obj.ox1H,    obj.ox2H,               ...
                         obj.fu1,     obj.fu2,                ...
                         obj.fu1wt,   obj.fu2wt,              ...
                         obj.fu1T,    obj.fu2T,               ...
                         obj.fu1chem, obj.fu2chem,            ...
                         obj.fu1H,    obj.fu2H,               ...
                         obj.Pc,      obj.OF,     obj.Phi,    ...
                         obj.PR,      obj.subar,  obj.supar,  ...
                         obj.CR,      obj.flow,   obj.out);
         
         % execute CEA600
         if isunix
             % Call CEA600 elsewhere
             % disp('CEAinput.runCEA: skipping CEA call');
         else
             system('CEA600.exe');
         end
      ...
      function CEA_out = getCEAresults(obj, dataLoc, units)
            ...
            if isempty(strfind(CEA_output, 'MASS FRACTIONS')) ~= 1
               ...
               for i = 1:length(split)
                 ...
                 for j  = 1:length(compounds(1,2:end))
                    % grab the mass/mole fraction values, regexp destroys decimal so this is how to get it back (CEA displays in .xxxxx)
                    value_array(i,j) = str2double(compounds(1, j+1))/1e5;    
                 end
        ...
        % Output struct
            CEA_out = struct('Mach', Mach_array(dataLoc), ...
                             'P0',    P0,  ...
                             'T0',    T0, ...
                             'Cstar', C_star,  ...
                             'Ivac',  Isp_vac, ... 
                             'Isp',   Isp,  ...
                             'CF',    Cf,  ...
                             'GAMMA', gamma_array(dataLoc),  ...
                             'Cp',    cp_array(dataLoc),  ...
                             'mu',    mu_array(dataLoc),  ...
                             'k',     k_array(dataLoc), ...
                             'Pr',    Pr_array(dataLoc), ...
                             'a',     a_array(dataLoc),...
                             'rho',   rho_array(dataLoc),  ...
                             'T',     T_array(dataLoc),  ...
                             'P',     P_array(dataLoc),  ...
                             'eps',   eps,  ...
                             'massf', massf, ...
